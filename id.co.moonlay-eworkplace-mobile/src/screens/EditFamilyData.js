...
class EditFamilyData extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    moveToDetail() {
        this.props.navigation.navigate('EditFamilyDataForm')
    }
                            ...
                            <View containerStyle={styles.container1}>
                                <View style={{ flexDirection: 'row' }}>
                                    <View style={{ flexDirection: 'column'}}>
                                        ...
                                        <Icon3 name="user-friends" size={50} style={{ marginLeft:'50%' }}/>
                                    ...
                                    <Card containerStyle={styles.card1}>
                                        <View style={{ flexDirection: 'row' ,justifyContent:'space-between'}}>
                                            <View style={{ flexDirection: 'column' }}>
                                                ...
                                                <Text style={{ fontSize:15}}>10 January 1954</Text>
                                            </View>
...
export default connect(mapStateToPropsData, mapDispatchToPropsData)(EditFamilyData)