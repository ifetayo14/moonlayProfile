...
class Profile extends Component {
  ...
  async loadData(){
    ...
    const photo = await AsyncStorage.getItem('photoUri');
  ...
  movetoClockinHistory() {
    this.props.navigation.navigate('ListProfileDetail')
  }
              ...
              <ScrollView
                ...
                onRefresh={this.loadData} />
                  ...
                  <View style={{ flexDirection: 'row' }}>
                    ...
                    <Card containerStyle={styles.dcard}>
                      <TouchableOpacity onPress={this.movetoClockinHistory}>
                        <Text style={styles.text4}>Detail</Text>
                        <View style={{ flexDirection: 'row' }}>
                          <Icon2 name="menu" size={30} />
                          <Text style={styles.text6}>Details {'\n'} Profile</Text>
                        </View>
                      </TouchableOpacity>
                    </Card>
                  </View>
