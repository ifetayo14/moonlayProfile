...
class EditEmergencyContact extends Component {
    ...
    moveToDetail() {
        this.props.navigation.navigate('EditEmergencyContactForm')
    }
                            ...
                            <View containerStyle={styles.container1}>
                                <View style={{ flexDirection: 'row' }}>
                                    <View style={{ flexDirection: 'column'}}>
                                        ...
                                        <Icon4 name="contact-phone" size={50} style={{ marginLeft:'50%' }}/>
...
export default connect(mapStateToPropsData, mapDispatchToPropsData)(EditEmergencyContact)