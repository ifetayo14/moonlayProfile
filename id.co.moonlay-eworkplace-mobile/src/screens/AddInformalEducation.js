...
import { View, Text, StyleSheet, CheckBox, SafeAreaView, Picker, ScrollView, TouchableOpacity, RefreshControl, TextInput, Image } from 'react-native';
...
class AddInformalEducational extends Component {
    constructor(props) {
        super(props);
        this.state = {
...
export default connect(mapStateToPropsData, mapDispatchToPropsData)(AddInformalEducational)