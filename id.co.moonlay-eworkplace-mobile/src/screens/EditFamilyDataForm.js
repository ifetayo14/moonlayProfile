...
class EditFamilyDataForm extends Component {
    constructor(props) {
        super(props);
        this.state = {
                    ...
                    <View style={styles.view1}>
                        ...
                        <View containerStyle={styles.container1}>
                            <View style={{
                                ...
                                <View>
                                    <Text style={styles.text9}>KTP Number</Text>
                                    <TextInput
                                    style={styles.textInputContainer}
                                    placeholder=""
                                    placeholderTextColor="#000" />
                                </View>
                                <View style={styles.addEmergencyContainer}>
                                    <CheckBox />
                                    <Text style={styles.text11}>Add Emergency Contact</Text>
                                </View>
                                <View style={{alignItems:'flex-end'}}>
                                    <TouchableOpacity >
                                        <View style={styles.btn}>
                                            <Text style={{color:'white', fontFamily:'Roboto', fontSize:20}}>Save Changes</Text>
                                        </View>
                                    </TouchableOpacity>
                                </View>
                            </View>
...
export default connect(mapStateToPropsData, mapDispatchToPropsData)(EditFamilyDataForm)