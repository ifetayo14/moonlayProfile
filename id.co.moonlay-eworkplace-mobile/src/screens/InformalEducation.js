...
class InformalEducataion extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    moveToAdd() {
        this.props.navigation.navigate('AddInformalEducation')
    }
    moveToDetail() {
        this.props.navigation.navigate('EditInformalEducation')
    }
                            ...
                            <View containerStyle={styles.container1}>
                                <View style={{ flexDirection: 'row' }}>
                                    <View style={{ flexDirection: 'column'}}>
                                        ...
                                        <Icon1 name="cast-education" size={50} style={{ marginLeft: '50%' }} />
                                        <TouchableOpacity style={{ justifyContent: 'center' }} onPress={this.moveToAdd}>
                                            <Text style={{marginLeft:50, fontSize:18, color:'blue'}}>+ Add</Text>
                                        </TouchableOpacity>
                                        </View>
                                    ...
                                    <Card containerStyle={styles.card1}>
                                        <View style={{ flexDirection: 'row' ,justifyContent:'space-between'}}>
                                            <View style={{ flexDirection: 'column' }}>
                                                <Text style={{ fontSize:20}}>UNESCO</Text>
                                                <Text style={{ fontSize:15}}>2016</Text>
                                            </View>
                                                <View style={{ flexDirection: 'row', alignSelf: 'center' }}>
                                                    <TouchableOpacity>
                                                        <Icon2 name="trash" size={20} />
                                                    </TouchableOpacity>
                                                </View>
                                        </View>
                                    </Card>
...
export default connect(mapStateToPropsData, mapDispatchToPropsData)(InformalEducataion)