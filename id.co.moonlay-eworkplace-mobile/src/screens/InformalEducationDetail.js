...
class InformalEducataionDetail extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    moveToDetail() {
        this.props.navigation.navigate('DetailInformalEducation')
    }
            ...
            <SafeAreaView style={styles.container}>
                <ScrollView
                    ...
                    <View style={styles.view1}>
                                    ...
                                    <Icon1 name="cast-education" size={50} style={{ marginLeft: '45%' }} />
...
export default connect(mapStateToPropsData, mapDispatchToPropsData)(InformalEducataionDetail)