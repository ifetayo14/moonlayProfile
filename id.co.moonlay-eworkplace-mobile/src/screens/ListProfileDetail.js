...
class ListProfileDetail extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    moveToWorkingExperience() {
        this.props.navigation.navigate('FormalExperience')
    }

    moveToInformal() {
        this.props.navigation.navigate('InformalEducationDetail')
    }
    ...
    moveToFamilyData() {
        this.props.navigation.navigate('FamilyData')
    }
...
export default connect(mapStateToPropsData, mapDispatchToPropsData)(ListProfileDetail)