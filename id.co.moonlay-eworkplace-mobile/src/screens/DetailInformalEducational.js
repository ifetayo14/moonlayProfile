...
class DetailInformalEducational extends Component {
    constructor(props) {
        super(props);
        this.state = {
                            ...
                            <View style={{
                                ...
                                <TouchableOpacity>
                                    <View style={styles.btnRemove}>
                                        <Text style={{color:'white', fontSize:20, margin:5}}>Remove</Text>
                                    </View>
                                </TouchableOpacity>
                            </View>
                        </View>
...
export default connect(mapStateToPropsData, mapDispatchToPropsData)(DetailInformalEducational)