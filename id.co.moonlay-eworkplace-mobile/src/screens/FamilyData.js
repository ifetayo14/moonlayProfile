...
class FamilyData extends Component {
    ...
    moveToDetail() {
        this.props.navigation.navigate('DetailFamilyData')
    }
                                ...
                                <View style={{ flexDirection: 'column'}}>
                                    ...
                                    <TouchableOpacity>
                                        <Card containerStyle={styles.card1}>
                                            <View style={{ flexDirection: 'row' ,justifyContent:'space-between'}}>
                                                <View style={{ flexDirection: 'column' }}>
                                                    <Text style={{ fontSize:20}}>Hosea Hutahuruk</Text>
                                                    <Text style={{ fontSize:15}}>Father</Text>
                                                    <Text style={{ fontSize:15}}>20 May 1984</Text>
                                                </View>
                                            </View>
                                        </Card>
                                    </TouchableOpacity>
...
export default connect(mapStateToPropsData, mapDispatchToPropsData)(FamilyData)